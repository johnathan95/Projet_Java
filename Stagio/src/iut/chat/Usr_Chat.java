...
/**
 * Procédure qui permet de fermer la fenetre Cli_GUI
 */
 void fermer(){
  this.dispose();
}
...
/**
 * Procédure qui met à jour la liste des destinaires d'un client lors de la connexion d'un nouveau client  
 */
...
/**
 * Procédure qui met à jour la liste des destinataires d'un client
 */
...
/**
 * Procédure qui met à jour la liste des messages recues d'un client
 */
...
C.update("["+com.get_src()+"] : "+com.get_msg());
  ...
  /**
   * Procédure qui permet d'informer le client que le serveur est injoignable
   */
  ...
  /**
   * Procédure qui permet d'informer le client que le serveur est joignable
   */
