...
public class Client extends JFrame implements Serializable {
	...
	private void jbInit() throws Exception {
		...
		File.setIcon(new ImageIcon(
				"C:/Users/johnathan/Desktop/DUT/PROG WEB/Site de Gestion de Stage sans CMS/images/Avis.png"));
		Help.setText("Aide");
	...
	protected void processWindowEvent(WindowEvent e) {
		if (e.getID() == WindowEvent.WINDOW_CLOSING) {
			if (User.srv_state) {
				try {
					J = (Contrat) Naming.lookup("rmi://" + User.srv_Adr
							+ ":1099/JChat");
